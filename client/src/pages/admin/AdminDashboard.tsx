...
export default function AdminDashboard() {
  ...
  const metrics = [
    ...
    { label: "Total Orders", value: stats?.totalOrders ?? 0, icon: ShoppingCart, color: "text-[#d3c4ab]", bg: "bg-[#f2ede6]" },
    { label: "Products", value: stats?.totalProducts ?? 0, icon: Package, color: "text-[#baac96]", bg: "bg-[#d0f0ed]" },
