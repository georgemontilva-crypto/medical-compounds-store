...
const KNOWN_SLOTS: Array<{ slotKey: string; label: string; section: string; recommended: string }> = [
  ...
  { slotKey: "home_sunny_banner_image_mobile", label: "Meet Sunny Banner — Versión Mobile/Tablet", section: "Home — Hero & Secciones", recommended: "Opcional — si no se sube, usa la imagen desktop recortada desde arriba. Portrait 3:4, ≥900×1200, con la cara/sujeto en el tercio superior (el tercio inferior queda cubierto por el degradado y el título)." },
